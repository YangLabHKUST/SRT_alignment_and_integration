...
for sample_choose in range(3):
    ...
    # pis_dict['ss'] = ss
    # np.savez('../../results/DLPFC/paste2_pis_Sample{}_DLPFC.npz'.format(sample_map[sample_choose]), **pis_dict)
    #
    # pis_dict = np.load('../../results/DLPFC/paste2_pis_Sample{}_DLPFC.npz'.format(sample_map[sample_choose]))
    ...
    # # save new coordinates for STitch3D experiments
    # for i, anndata_obj in enumerate(new_slices):
    #     file_name = "../../results/stitch3d_use/DLPFC/paste2_Sample{}_slice{}_DLPFC.h5ad".format(
    ...
    save_path = "../../results/DLPFC/paste2_Sample{}_DLPFC.png".format(sample_map[sample_choose])
    ...
    fig.delaxes(axs[1, 1])
    save_path = "../../results/DLPFC/paste2_individual_Sample{}_DLPFC.png".format(
