...
for i in range(3):
    ...
    adata_concat.write('../../results/partial_DLPFC_0.85/staligner_Sample{}_partial_DLPFC.h5ad'.format(sample_map[i]))

    adata = sc.read_h5ad('../../results/partial_DLPFC_0.85/staligner_Sample{}_partial_DLPFC.h5ad'.format(sample_map[i]))
    ...
    save_path = "../../results/partial_DLPFC_0.85/staligner_Sample{}_partial_DLPFC.png".format(sample_map[i])
...
edge_list = [[left, right] for left, right in zip(adata_concat.uns['edgeList'][0], adata_concat.uns['edgeList'][1])]
adata_concat.uns['edgeList'] = edge_list
adata_concat.write('../../results/partial_DLPFC_0.85/staligner_Sample_all_partial_DLPFC.h5ad')